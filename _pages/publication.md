...
## 2025
1. [TMLR] Yuzhu Mao, Zihao Zhao, Siqi Ping, Yang Liu and **Wenbo Ding\***, “Enhancing Parameter Efficiency and Generalization in Large Models: A Regularized and Masked Low-Rank Adaptation Approach,” Transactions on Machine Learning Research (TMLR), accepted. 
2. [ICLR] Yixian Zhang, Huaze Tang, Huijing Lin and **Wenbo Ding\***, "Residual Kernel Policy Network: Enhancing Stability and Robustness in RKHS-Based Reinforcement Learning," The Thirteenth International Conference on Learning Representations (ICLR 2025), accepted.
3. [ICASSP] Enze Zhang#, Huaze Tang#, Xiao-Ping Zhang and **Wenbo Ding\***, "Mean-Field Aided QMIX: A Scalable and Flexible Q-Learning Approach for Large-Scale Agent Groups," IEEE International Conference on Acoustics, Speech, and Signal Processing (ICASSP 2025), accepted.
## 2024
